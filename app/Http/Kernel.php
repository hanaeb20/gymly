...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'is_gerant' => \App\Http\Middleware\IsGerantMiddleware::class,
        'simple_gerant' => \App\Http\Middleware\SimpleGerantMiddleware::class,
        'basic_gerant' => \App\Http\Middleware\BasicGerantMiddleware::class,
    ];
}
