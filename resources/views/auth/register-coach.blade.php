    ...
    <div class="form-section">
        ...
        <div class="registration-form">
            ...
            <div class="profile-tabs">
                ...
                <a href="{{ route('register.coach') }}" class="profile-tab active">
            ...
            <form method="POST" action="{{ route('register') }}" class="animated-form">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control @error('nom') is-invalid @enderror" name="nom" value="{{ old('nom') }}" placeholder="Votre nom" required>
                ...
                <div class="form-floating">
                    <input type="text" class="form-control @error('prenom') is-invalid @enderror" name="prenom" value="{{ old('prenom') }}" placeholder="Votre prénom" required>
                    <div class="form-icon"><i class="fas fa-user"></i></div>
                    <div class="form-line"></div>
                    @error('prenom')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="form-floating">
                    <input type="text" class="form-control @error('inscription_code') is-invalid @enderror" name="inscription_code" value="{{ old('inscription_code') }}" placeholder="Code d'inscription" required>
                    <div class="form-icon"><i class="fas fa-key"></i></div>
                    <div class="form-line"></div>
                    @error('inscription_code')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>

                <div class="form-floating">
                    <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Votre adresse email" required>
                ...
                <div class="form-floating">
                    <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" placeholder="Confirmez votre mot de passe" required>
                    <div class="form-icon"><i class="fas fa-lock"></i></div>
                    <div class="form-line"></div>
...
<style>
    ...
    .image-section::before {
        ...
        right: 0;
        bottom: 0;
        background: url('/images/coach.jpeg') center/cover no-repeat;
