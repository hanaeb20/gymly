        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('gerant.salles.store') }}" enctype="multipart/form-data">
                        @csrf

                        <div class="row mb-3">
                            <label for="nom" class="col-md-4 col-form-label text-md-end">{{ __('Nom de la salle') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="capacite" class="col-md-4 col-form-label text-md-end">{{ __('Capacité') }}</label>

                            <div class="col-md-6">
                                <input id="capacite" type="number" class="form-control @error('capacite') is-invalid @enderror" name="capacite" value="{{ old('capacite') }}" required min="1">
                        ...
                        <div class="row mb-3">
                            <label for="prix_abonnement" class="col-md-4 col-form-label text-md-end">{{ __('Prix de l\'abonnement') }}</label>

                            <div class="col-md-6">
                                <input id="prix_abonnement" type="number" step="0.01" class="form-control @error('prix_abonnement') is-invalid @enderror" name="prix_abonnement" value="{{ old('prix_abonnement') }}" required min="0">
                        ...
                        <div class="row mb-3">
                            <label for="photos" class="col-md-4 col-form-label text-md-end">{{ __('Photos de la salle') }}</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-muted">
                                    Vous pouvez sélectionner plusieurs photos. Formats acceptés : JPG, PNG, JPEG. Taille maximale : 2MB par photo.
                                </small>
                            </div>
                        </div>
